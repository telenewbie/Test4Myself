...
typedef struct {
  ...
  // duanxiang save  history far 
  float spectrum_far_history[125][65];
  int history_size;
...
typedef struct {
  ...
  //duanxiang near history
  float spectrum_near_history[125+1][65];
...
//duanxiang
void DUAN_WebRtc_AddBinaryFarSpectrum(BinaryDelayEstimatorFarend* self,
...
//duanxiang
int DUAN_WebRtc_ProcessBinarySpectrum(BinaryDelayEstimator* self,
