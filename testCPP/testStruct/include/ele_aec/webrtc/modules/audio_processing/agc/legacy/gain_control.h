 ...
 *                          : -1 - Error
 */
__declspec(dllexport) int WebRtcAgc_Process(void* agcInst,
 ...
 *                          : -1 - Error
 */
__declspec(dllexport) int WebRtcAgc_set_config(void* agcInst, WebRtcAgcConfig config);
 ...
 */
__declspec(dllexport) void* WebRtcAgc_Create();
 ...
 *      - agcInst           : AGC instance.
 */
__declspec(dllexport) void WebRtcAgc_Free(void* agcInst);
 ...
 *                            -1 - Error
 */
__declspec(dllexport) int WebRtcAgc_Init(void* agcInst,
                   int32_t minLevel,
                   int32_t maxLevel,
                   int16_t agcMode,
                   uint32_t fs);
