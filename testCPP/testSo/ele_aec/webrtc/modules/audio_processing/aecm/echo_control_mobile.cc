...
void WebRtcAecm_CleanBuffer(void * aecmInst)
{
	AecMobile* aecm = static_cast<AecMobile*>(aecmInst);
	WebRtc_InitBuffer(aecm->farendBuf);
}

int WebRtcAecm_GetBufferSize(void *aecmInst) {
	AecMobile* aecm = static_cast<AecMobile*>(aecmInst);
	return WebRtc_available_read(aecm->farendBuf);
}

int WebRtcAecm_GetLeftBufferSize(void *aecmInst)
{
	AecMobile* aecm = static_cast<AecMobile*>(aecmInst);
	return WebRtc_available_write(aecm->farendBuf);
}
