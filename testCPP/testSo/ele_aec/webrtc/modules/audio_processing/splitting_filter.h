...
struct __declspec(dllexport) TwoBandsStates {
  TwoBandsStates() {
...
class  SplittingFilter {
 public:
	 __declspec(dllexport)  SplittingFilter(size_t num_channels, size_t num_bands, size_t num_frames);
	 __declspec(dllexport)  ~SplittingFilter();

	 __declspec(dllexport)  void Analysis(const IFChannelBuffer* data, IFChannelBuffer* bands);
	 __declspec(dllexport) void Synthesis(const IFChannelBuffer* bands, IFChannelBuffer* data);
