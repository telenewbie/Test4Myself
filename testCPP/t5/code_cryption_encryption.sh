...
OBJDUMP=${OBJDUMP:="/home/txz/raymond/opt/xinyangquan/ext-toolchain/bin/arm-linux-gnueabi-objdump"}
READELF=${READELF:="/home/txz/raymond/opt/xinyangquan/ext-toolchain/bin/arm-linux-gnueabi-readelf"}
libfile=$1
