...
#define TEAMS_DLLEXPORT  __declspec(dllexport) 
 ...
 */
TEAMS_DLLEXPORT void* WebRtcAec_Create();
 ...
 */
TEAMS_DLLEXPORT void WebRtcAec_Free(void* aecInst);
 ...
 *                             -1: error
 */
TEAMS_DLLEXPORT int32_t WebRtcAec_Init(void* aecInst, int32_t sampFreq, int32_t scSampFreq);

TEAMS_DLLEXPORT void WebRtcAec_CleanBuffer(void *aecInst);
TEAMS_DLLEXPORT int32_t WebRtcAec_GetLeftBufferSize(void *aecInst);
 ...
 */
TEAMS_DLLEXPORT int32_t WebRtcAec_BufferFarend(void* aecInst,
                               const float* farend,
                               size_t nrOfSamples);
 ...
 *                              12000-12050: error code
 */
TEAMS_DLLEXPORT int32_t WebRtcAec_GetBufferFarendError(void* aecInst,
                                       const float* farend,
                                       size_t nrOfSamples);
 ...
 *                              12000-12050: error code
 */
TEAMS_DLLEXPORT int32_t WebRtcAec_Process(void* aecInst,
 ...
 *                              12000-12050: error code
 */
TEAMS_DLLEXPORT int WebRtcAec_set_config(void* handle, AecConfig config);
 ...
 *                              12000-12050: error code
 */
TEAMS_DLLEXPORT int WebRtcAec_get_echo_status(void* handle, int* status);
 ...
 *                              12000-12050: error code
 */
TEAMS_DLLEXPORT int WebRtcAec_GetMetrics(void* handle, AecMetrics* metrics);
 ...
 *                              12000-12050: error code
 */
TEAMS_DLLEXPORT int WebRtcAec_GetDelayMetrics(void* handle,
                              int* median,
                              int* std,
...
//
TEAMS_DLLEXPORT struct AecCore* WebRtcAec_aec_core(void* handle);

TEAMS_DLLEXPORT int32_t ns_post_spectrum(void* aecInst,float en_spec[2][481],float *far_sig, float alpha, float psdth_L);

TEAMS_DLLEXPORT int32_t fdesignParameq(float *output_sig,int len, float *output_eq);
TEAMS_DLLEXPORT int32_t fdesignParameq2(float *output_sig,int len, float *output_eq);
