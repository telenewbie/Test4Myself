...
public:
    ...
    virtual int resampler_process(int index,short * inBuffer,uint32_t inLen, short* outBuffer , uint32_t & outLen) override;
    virtual int resampler_process(int index,float * inBuffer,uint32_t inLen, float* outBuffer , uint32_t & outLen) override;
